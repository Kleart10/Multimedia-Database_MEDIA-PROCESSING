...
# Using JSON instead of pgvector.sqlalchemy.Vector for Windows compatibility
# pgvector extension is not available on Windows PostgreSQL by default
...
class ImageFeatures(db.Model):
    ...
    color_histogram = db.Column(JSON)
    texture_lbp = db.Column(JSON)
    deep_features = db.Column(JSON)
    combined_features = db.Column(JSON)
...
class AudioFeatures(db.Model):
    ...
    # Feature vectors stored as JSON arrays
    mfcc_features = db.Column(JSON)
    spectral_features = db.Column(JSON)
    waveform_stats = db.Column(JSON)
    combined_features = db.Column(JSON)
...
class VideoFeatures(db.Model):
    ...
    # Feature vectors stored as JSON arrays
    keyframe_features = db.Column(JSON)
    motion_features = db.Column(JSON)
    scene_stats = db.Column(JSON)
    combined_features = db.Column(JSON)
